      ...
      try
          ...
          if checkbox1.Checked  then  Sql := 'select * from Main_Comp where ccode=''' + edtCode.Text +''''
            ...
            //  Sql := 'select * from Main_Comp where sosok < 2 and curPrice > 1000 and SaleAmount > 0 and  SalesProfit > 10 and DEBTTOTAL <= SALEAMOUNT * 0.5 order by ccode';
              ...
              Sql := Sql  + ' AND  (B.HIGHPRICE - B.LOWPRICE)*100/(B.ENDPRICE- B.DAYGAP) > 10 and A.SaleAmount > 0 and  A.SalesProfit > 10 and A.DEBTTOTAL <= A.SALEAMOUNT * 0.5 and ';
...
begin
      ...
      else Sql := 'select * from Main_Comp where sosok < 2 and curPrice > 1000 and SaleAmount > 0 and  SalesProfit > 10 and DEBTTOTAL <= SALEAMOUNT * 0.5 order by ccode';
      StartDate := DateTimePicker1.Date;
      EndDate :=StartDate;
